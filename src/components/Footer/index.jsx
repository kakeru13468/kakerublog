      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-wrap items-center justify-between">
          <div className="flex items-center space-x-4">
            <span className="text-blue-400 font-semibold">Kakeru Blog</span>
            <span className="text-gray-400 hidden md:inline">|</span>
            <a href="mailto:kakeru.kaixiang@gmail.com" className="text-gray-400 hover:text-blue-400 transition-colors text-sm hidden md:flex items-center">
              <svg className="w-4 h-4 mr-1" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                <path d="M2.003 5.884L10 9.882l7.997-3.998A2 2 0 0016 4H4a2 2 0 00-1.997 1.884z" />
                <path d="M18 8.118l-8 4-8-4V14a2 2 0 002 2h12a2 2 0 002-2V8.118z" />
              </svg>
              kakeru.kaixiang@gmail.com
            </a>
          </div>
          ...
          <div className="flex items-center space-x-3">
            ...
            <span className="text-gray-500 text-xs ml-2">© {new Date().getFullYear()}</span>
          </div>
        </div>
      </div>
    </footer>
